						...
						if ( settings.show_negative_prompt ) {
							...
							#>">
								<div class="sc_igenerator_form_field_inner">
									...
									<input type="text" value="{{ settings.negative_prompt }}" id="sc_igenerator_form_field_negative_prompt_text" class="sc_igenerator_form_field_negative_prompt_text" placeholder="<?php esc_attr_e( "Items you don't want in the image", 'trx_addons' ); ?>">
								</div>
							</div><#
						}
