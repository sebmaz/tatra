					...
					if ( ! empty( $args['show_negative_prompt'] ) ) {
						...
						?>">
							<div class="sc_igenerator_form_field_inner">
								...
								<input type="text" value="<?php echo esc_attr( $args['negative_prompt'] ); ?>" id="sc_igenerator_form_field_negative_prompt_text" class="sc_igenerator_form_field_negative_prompt_text" placeholder="<?php esc_attr_e( "Items you don't want in the image", 'trx_addons' ); ?>">
							</div>
						</div><?php
					}
...
} else if ( trx_addons_is_preview() ) {

	?><div class="sc_igenerator_error"><?php
		esc_html_e( 'No models available', 'trx_addons' );
	?></div><?php
