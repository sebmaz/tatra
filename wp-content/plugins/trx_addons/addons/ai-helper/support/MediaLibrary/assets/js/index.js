					...
					<div id="trx-addons-ai-helper-image-generator-body">
						<div id="trx-addons-ai-helper-image-generator-settings">
							<div id="trx-addons-ai-helper-image-generator-settings-new">
									...
									<div class="trx-addons-ai-helper-image-generator-settings-item-field"><#
										...
										#><div class="trx-addons-ai-helper-image-generator-settings-popup"><#
											...
											#><div class="trx-addons-ai-helper-image-generator-settings-field trx-addons-ai-helper-image-generator-settings-field-guidance-scale">
												<label for="trx-addons-ai-helper-image-generator-settings-field-guidance-scale">{{ wp.i18n.__('Guidance scale:') }}</label>
												<input type="number"
												...
												>
												<div class="trx-addons-ai-helper-image-generator-settings-field-description">{{ wp.i18n.__( 'Scale for classifier-free guidance (min: 1; max: 20)' ) }}</div>
											</div><#
											...
											#><div class="trx-addons-ai-helper-image-generator-settings-field trx-addons-ai-helper-image-generator-settings-field-inference-steps">
												<label for="trx-addons-ai-helper-image-generator-settings-field-inference-steps">{{ wp.i18n.__('Inference steps:') }}</label>
												<input type="number"
												...
												>
												<div class="trx-addons-ai-helper-image-generator-settings-field-description">{{ wp.i18n.__( 'Number of denoising steps. The value accepts 21,31,41 and 51.') }}</div>
											</div><#
											...
											#><div class="trx-addons-ai-helper-image-generator-settings-field trx-addons-ai-helper-image-generator-settings-field-cfg-scale">
												<label for="trx-addons-ai-helper-image-generator-settings-field-cfg-scale">{{ wp.i18n.__('Cfg scale:') }}</label>
												<input type="number"
												...
												>
												<div class="trx-addons-ai-helper-image-generator-settings-field-description">{{ wp.i18n.__( 'How strictly the diffusion process adheres to the prompt text (higher values keep your image closer to your prompt)' ) }}</div>
											</div><#
											...
											#><div class="trx-addons-ai-helper-image-generator-settings-field trx-addons-ai-helper-image-generator-settings-field-diffusion-steps">
												<label for="trx-addons-ai-helper-image-generator-settings-field-diffusion-steps">{{ wp.i18n.__('Diffusion steps:') }}</label>
												<input type="number"
												...
												>
												<div class="trx-addons-ai-helper-image-generator-settings-field-description">{{ wp.i18n.__( 'Number of diffusion steps to run.' ) }}</div>
											</div><#
											...
											#><div class="trx-addons-ai-helper-image-generator-settings-field trx-addons-ai-helper-image-generator-settings-field-seed">
												<label for="trx-addons-ai-helper-image-generator-settings-field-seed">{{ wp.i18n.__('Seed:') }}</label>
												<input type="number"
														...
														value="0"
												>
												<div class="trx-addons-ai-helper-image-generator-settings-field-description">{{ wp.i18n.__( 'Seed is used to reproduce results, same seed will give you same image in return again. Pass 0 for a random number.' ) }}</div>
											</div>
										</div>
									</div>
								</div><#
								...
								#><div class="trx-addons-ai-helper-image-generator-settings-item">
									...
									<div class="trx-addons-ai-helper-image-generator-settings-item-field">
										<textarea id="trx-addons-ai-helper-image-generator-negative-prompt" rows="1"
											placeholder="{{ wp.i18n.__( "Items you don't want in the image" ) }}"><#
								...
								#><div class="trx-addons-ai-helper-image-generator-settings-item">
									<label for="trx-addons-ai-helper-image-generator-style-openai" class="trx-addons-ai-helper-image-generator-settings-item-title">{{ wp.i18n.__( 'Style' ) }}</label>
									<div class="trx-addons-ai-helper-image-generator-settings-item-field">
							...
							#><div class="trx-addons-ai-helper-image-generator-settings-subtitle trx-addons-ai-helper-image-generator-settings-selected-subtitle trx_addons_hidden">
								<h3>{{ wp.i18n.__( 'Process the selected image' ) }}</h3>
								<a href="#" id="trx-addons-ai-helper-image-generator-settings-selected-delete" title="{{ wp.i18n.__( 'Delete the selected image from the preview area (not from the Media Library)' ) }}"><span class="dashicon dashicons-delete"></span>{{ wp.i18n.__( 'Delete' ) }}</a>
							</div>
							<div id="trx-addons-ai-helper-image-generator-settings-selected" class="trx_addons_hidden">
								<div class="trx-addons-ai-helper-image-generator-settings-actions">
									<ul class="trx-addons-ai-helper-image-generator-settings-actions-list">
										<li class="trx-addons-ai-helper-image-generator-settings-actions-item trx-addons-ai-helper-image-generator-settings-actions-item-add-to-library trx-addons-ai-helper-image-generator-settings-actions-item-active"><a href="#" data-action="add_to_library">{{ wp.i18n.__( 'Add to Library' ) }}</a></li>
										<li class="trx-addons-ai-helper-image-generator-settings-actions-item trx-addons-ai-helper-image-generator-settings-actions-item-variations"><a href="#" data-action="variations">{{ wp.i18n.__( 'Variations' ) }}</a></li>
										<li class="trx-addons-ai-helper-image-generator-settings-actions-item trx-addons-ai-helper-image-generator-settings-actions-item-upscale"><a href="#" data-action="upscale">{{ wp.i18n.__( 'Upscale' ) }}</a></li>
								...
								#><div class="trx-addons-ai-helper-image-generator-settings-item" data-actions="variations">
									<div class="trx-addons-ai-helper-image-generator-settings-item-field trx-addons-ai-helper-image-generator-settings-item-field-variations">
										<p>{{ wp.i18n.__( 'Fill in the fields in the image generation form above (model, prompts, size, quantity, etc.) and click the "Make variations" button' ) }}</p>
										<p>{{ wp.i18n.__( 'Note: Since the Stable Diffusion API requires URL access to the source image, your site must be accessible from the Internet. This means that "Make variations" and "Upscale" operations are not available on a local installation with models from this API.' ) }}</p>
									</div>
								</div>
								<div class="trx-addons-ai-helper-image-generator-settings-item" data-actions="variations">
								...
								#><div class="trx-addons-ai-helper-image-generator-settings-item" data-actions="upscale">
									<label for="trx-addons-ai-helper-image-generator-upscaler" class="trx-addons-ai-helper-image-generator-settings-item-title">{{ wp.i18n.__( 'Upscaler' ) }}</label>
									<div class="trx-addons-ai-helper-image-generator-settings-item-field">
								...
								<div class="trx-addons-ai-helper-image-generator-settings-item" data-actions="upscale">
									<label for="trx-addons-ai-helper-image-generator-upscale-factor" class="trx-addons-ai-helper-image-generator-settings-item-title">{{ wp.i18n.__( 'Upscale factor' ) }}</label>
									<div class="trx-addons-ai-helper-image-generator-settings-item-field">
								...
								<div class="trx-addons-ai-helper-image-generator-settings-item" data-actions="upscale">
									<label for="trx-addons-ai-helper-image-generator-upscale-width" class="trx-addons-ai-helper-image-generator-settings-item-title">{{ wp.i18n.__( 'Width or Height' ) }}</label>
									<div class="trx-addons-ai-helper-image-generator-settings-item-field">
								...
								<div class="trx-addons-ai-helper-image-generator-settings-item" data-actions="upscale">
									<button id="trx-addons-ai-helper-image-generator-make-upscale" type="button" class="components-button trx-addons-ai-helper-image-generator-button is-primary">
										<span class="dashicon dashicons dashicons-format-gallery trx-addons-ai-helper-image-generator-button-icon"></span>
										<span class="trx-addons-ai-helper-image-generator-button-text">{{ wp.i18n.__( 'Upscale image' ) }}</span>
									</button>
								</div>
							</div><#
...
//				}
	...
	var newMediaFrame = {
		...
		aiHelperAddAttachmentVariationsButton: function() {
			...
			$info.find( '.edit-attachment' ).after( '<button type="button" class="button-link variations-attachment">' + __( 'Variations or Upscale' ) + '</button>' );
