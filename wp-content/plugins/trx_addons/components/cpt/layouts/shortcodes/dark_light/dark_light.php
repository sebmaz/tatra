...
if ( ! function_exists( 'trx_addons_cpt_layouts_dark_light_load_responsive_styles' ) ) {
	add_action( "wp_enqueue_scripts", 'trx_addons_cpt_layouts_dark_light_load_responsive_styles', TRX_ADDONS_ENQUEUE_RESPONSIVE_PRIORITY );
	function trx_addons_cpt_layouts_dark_light_load_responsive_styles() {
		if ( trx_addons_exists_page_builder() && trx_addons_is_on( trx_addons_get_option( 'debug_mode' ) ) ) {
			wp_enqueue_style( 
				'trx_addons-sc_layouts-dark_light-responsive', 
				trx_addons_get_file_url(TRX_ADDONS_PLUGIN_CPT_LAYOUTS_SHORTCODES . 'dark_light/dark_light.responsive.css'),
				array(), 
				null, 
				trx_addons_media_for_load_css_responsive( 'cpt-layouts-dark_light', 'xl' )
			);
		}
	}
}
...
if ( ! function_exists( 'trx_addons_sc_layouts_dark_light_merge_styles_responsive' ) ) {
	add_filter( "trx_addons_filter_merge_styles_responsive", 'trx_addons_sc_layouts_dark_light_merge_styles_responsive' );
	add_filter( "trx_addons_filter_merge_styles_responsive_layouts", 'trx_addons_sc_layouts_dark_light_merge_styles_responsive' );
	function trx_addons_sc_layouts_dark_light_merge_styles_responsive( $list ) {
		$list[ TRX_ADDONS_PLUGIN_CPT_LAYOUTS_SHORTCODES . 'dark_light/dark_light.responsive.css' ] = true;
		return $list;
	}
}
