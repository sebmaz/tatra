...
if ( ! function_exists('snowy_get_not_selected_text') ) {
	/**
	 ...
	 */
	function snowy_get_not_selected_text( $label ) {
		return apply_filters( 'snowy_filter_not_selected_text',
								sprintf( apply_filters( 'snowy_filter_not_selected_mask', __( '- %s -', 'snowy' ) ), $label )
							);
	}
}

if ( ! function_exists( 'snowy_get_list_range' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'snowy_get_list_styles' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'snowy' ), $i );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'snowy' ),
			'no'  => esc_html__( 'No', 'snowy' ),
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function snowy_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'snowy' ),
				0         => esc_html__( 'No', 'snowy' ),
			)
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'snowy_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'snowy' ),
			'off' => esc_html__( 'Off', 'snowy' ),
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'snowy' ),
			'hide' => esc_html__( 'Hide', 'snowy' ),
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'snowy' ),
			'hidden'  => esc_html__( 'Hidden', 'snowy' ),
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_directions' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'snowy' ),
			'vertical'   => esc_html__( 'Vertical', 'snowy' ),
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'snowy' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'snowy' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'snowy' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'snowy' ),
...
if ( ! function_exists( 'snowy_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'snowy' ),
				'icon'    => esc_html__( 'Icon', 'snowy' ),
				'icons'   => esc_html__( 'Icons', 'snowy' ),
				'zoom'    => esc_html__( 'Zoom', 'snowy' ),
				'fade'    => esc_html__( 'Fade', 'snowy' ),
				'slide'   => esc_html__( 'Slide', 'snowy' ),
				'pull'    => esc_html__( 'Pull', 'snowy' ),
				'border'  => esc_html__( 'Border', 'snowy' ),
				'excerpt' => esc_html__( 'Excerpt', 'snowy' ),
				'info'    => esc_html__( 'Info', 'snowy' ),
			)
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'snowy_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'snowy' ),
				'fullpost' => esc_html__( 'Full post', 'snowy' ),
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function snowy_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'snowy' ),
...
if ( ! function_exists( 'snowy_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = snowy_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			snowy_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = snowy_array_merge( array( 'hide' => snowy_get_not_selected_text( esc_html__( 'Select widgets', 'snowy' ) ) ), $list );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function snowy_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'snowy' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'snowy' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'snowy' ),
...
if ( ! function_exists( 'snowy_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'snowy' ),
				'below' => esc_html__( 'Below the content', 'snowy' ),
				'float' => esc_html__( 'Floating bar', 'snowy' ),
			)
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'snowy_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'snowy_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'snowy_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'snowy_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'snowy' ),
			'over'    => esc_html__( 'Over', 'snowy' ),
			'under'   => esc_html__( 'Under', 'snowy' ),
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'snowy_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function snowy_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'snowy' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'snowy' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'snowy_filter_allow_fullscreen', $force_fullscreen || snowy_get_theme_setting( 'allow_fullscreen' ) || snowy_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'snowy' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'snowy' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'snowy_filter_list_body_styles', $list );
		return $prepend_inherit
					? snowy_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'snowy_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function snowy_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'snowy_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'snowy' ),
...
if ( ! function_exists( 'snowy_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function snowy_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'snowy' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'snowy' ),
...
if ( ! function_exists( 'snowy_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'snowy' ),
				'date'       => esc_html__( 'Published date', 'snowy' ),
				'modified'   => esc_html__( 'Modified date', 'snowy' ),
				'views'      => esc_html__( 'Views', 'snowy' ),
				'likes'      => esc_html__( 'Likes', 'snowy' ),
				'comments'   => esc_html__( 'Comments', 'snowy' ),
				'share'      => esc_html__( 'Share links', 'snowy' ),
				'categories' => esc_html__( 'Categories', 'snowy' ),
				'edit'       => esc_html__( 'Edit link', 'snowy' ),
			)
		);
...
if ( ! function_exists( 'snowy_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'snowy_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function snowy_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'snowy' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'snowy' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'snowy_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? snowy_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'snowy_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function snowy_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'snowy_filter_list_single_styles', snowy_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? snowy_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'snowy_get_list_categories' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_categories( $prepend_inherit = false ) {
		$list = snowy_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'snowy_filter_term_name', $cat->name, $cat );
				}
			}
			snowy_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_terms' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = snowy_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'snowy_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			snowy_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_posts_types( $prepend_inherit = false ) {
		$list = snowy_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'snowy_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'snowy' ),
				)
			);
			snowy_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_posts' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = snowy_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? snowy_get_not_selected_text( esc_html__( 'Not selected', 'snowy' ) ) : $opt['not_selected'];
			}
			$args = array(
...
if ( ! function_exists( 'snowy_get_list_users' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = snowy_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = snowy_get_not_selected_text( esc_html__( 'Not selected', 'snowy' ) );
			$users        = get_users(
				array(
			...
			snowy_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_menus' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_menus( $prepend_inherit = false ) {
		$list = snowy_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'snowy' );
			...
			snowy_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_icons' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'snowy_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			if ( 'icons' == $style ) {
				$lists[ $style ] = snowy_array_from_list( snowy_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = snowy_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = snowy_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'snowy_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'snowy_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function snowy_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : snowy_parse_icons_classes( snowy_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = snowy_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'snowy_get_list_images' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'snowy_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function snowy_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'snowy_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'snowy' ),
				'link2'   => esc_html__( 'Accent 2', 'snowy' ),
				'link3'   => esc_html__( 'Accent 3', 'snowy' ),
				'dark'    => esc_html__( 'Dark', 'snowy' ),
			)
		);
		return $prepend_inherit ? snowy_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'snowy' ) ), $list ) : $list;
	}
