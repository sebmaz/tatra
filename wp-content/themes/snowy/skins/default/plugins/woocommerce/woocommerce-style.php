...
if ( ! function_exists( 'snowy_woocommerce_get_css' ) ) {
	add_filter( 'snowy_filter_get_css', 'snowy_woocommerce_get_css', 10, 2 );
	function snowy_woocommerce_get_css( $css, $args ) {
...
select option, .select_container select option,
...
$fdir = snowy_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
