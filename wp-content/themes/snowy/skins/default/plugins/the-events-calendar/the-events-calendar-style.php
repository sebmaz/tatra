...
if ( ! function_exists( 'snowy_tribe_events_get_css' ) ) {
	add_filter( 'snowy_filter_get_css', 'snowy_tribe_events_get_css', 10, 2 );
	function snowy_tribe_events_get_css( $css, $args ) {
