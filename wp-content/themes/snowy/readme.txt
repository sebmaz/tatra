...
Please install and activate it before starting to use the theme Snowy.
...
Theme documentation is available on https://snowy.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Snowy is Fontello.
